...
# 获取ToolDelta的最新版本
LatestTag=$(wget -qO- -t1 -T2 "https://github.yeqing.net/https://api.github.com/repos/ToolDelta-Basic/ToolDelta/releases/latest" | jq -r '.tag_name')
# 设置 GitHub release URL
github_release_url="https://github.yeqing.net/https://github.com/ToolDelta-Basic/ToolDelta/releases/download/${LatestTag}/ToolDelta-linux"
# 下载
